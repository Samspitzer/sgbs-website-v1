...
export function ServicesPage() {
  ...
  return (
    <div className="bg-dark-950">
      ...
      {/* ============ HERO SECTION ============ */}
      <section className="relative min-h-screen lg:h-screen overflow-hidden snap-section flex items-end">
        <div className="absolute inset-0">
          <div className="absolute inset-0 overflow-hidden opacity-35">
            <img src="/images/backgrounds/services.jpg" alt="" className="absolute w-full h-full object-cover" style={{ filter: 'blur(18px)', transform: 'scale(1.2)' }} />
          </div>
          <div className="absolute inset-0 overflow-hidden">
            <img src="/images/backgrounds/services.jpg" alt="" className="absolute w-full h-full object-cover hero-zoom-slow" style={{
              objectPosition: '50% 50%', transformOrigin: '50% 50%',
              '--zoom-from': 1.1, '--zoom-to': 1.03, '--focus-x': '50%', '--y-start': '30%', '--y-end': '50%',
        ...
        <div className="relative z-10 container-custom pb-16 lg:pb-28 pt-28 lg:pt-0">
